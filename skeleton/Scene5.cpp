...
void Scene5::loadScene()
{
	...
	Entity* p = mEntityManager->createMassParticle(Vector3(0.0, 10.0, 0.0), Vector3(0.0, 0.0, 0.0),
		Vector3(0.0, 0.0, 0.0), 1000.0, Vector3(0.0, 0.0, 0.0), 0.5, 0, 1.0, 0, 0, Vector3(), Vector4(1.0, 1.0, 1.0, 1.0));
	//water 
	...
	BuoyancyForceGenerator* aux = new BuoyancyForceGenerator(plane,10,10,1000,9.8);
